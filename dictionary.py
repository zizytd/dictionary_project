...
# this function makes the button_clear interactive
def clear():
  txt_dic.delete("1.0", tk.END)
...
button_clear = tk.Button(fr_button, text="Clear", command=clear, fg="green")
...
button_clear.grid(row=3, column=0, sticky="ew", padx=5)
